        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-lg text-muted-foreground font-outfit leading-relaxed">
              ...
              <p>
                We envisioned a space where men could relax, unwind, and receive
                a service that is tailored specifically to them. Our barbers are
                trained to understand not just hair, but the individual style
